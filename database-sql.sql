4,3-- This is just to test to make sure this work
...
) ENGINE=InnoDB AUTO_INCREMENT=712804665 DEFAULT CHARSET=latin1;
...
-- CREATE TABLE community_game_changer.user (
--   `profile_id` int(11) NOT NULL,
--   `username` varchar(255) NOT NULL,
--   `password` varchar(255) NOT NULL,
--   PRIMARY KEY (`profile_id`),
--   CONSTRAINT `user_profile_ibfk_1` FOREIGN KEY (`profile_id`) REFERENCES `user_profile` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE,
--   CONSTRAINT `business_profile_ibfk_2` FOREIGN KEY (`profile_id`) REFERENCES `business_profile` (`business_id`) ON DELETE CASCADE ON UPDATE CASCADE
-- ) ENGINE=InnoDB AUTO_INCREMENT=712804665 DEFAULT CHARSET=latin1;
...
CREATE TABLE community_game_changer.transaction (
  ...
  CONSTRAINT `user_profile_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `user_profile` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `business_profile_ibfk_1` FOREIGN KEY (`business_id`) REFERENCES `business_profile` (`business_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=712804665 DEFAULT CHARSET=latin1;

CREATE TABLE community_game_changer.orginization (
  `orginization_id` int(11) NOT NULL AUTO_INCREMENT,
  `province_code` varchar(255) NOT NULL,
  `community` varchar(255) NOT NULL,
  `sport` varchar(255) NOT NULL,
  `name` varchar(255) NOT NULL,
  PRIMARY KEY (`orginization_id`)
) ENGINE=InnoDB AUTO_INCREMENT=712804665 DEFAULT CHARSET=latin1;

CREATE TABLE community_game_changer.donation (
  `donation_id` int(11) NOT NULL AUTO_INCREMENT,
  `orginization_id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `donation_amount` double NOT NULL,
  PRIMARY KEY (`donation_id`),
  CONSTRAINT `user_profile_ibfk_3` FOREIGN KEY (`user_id`) REFERENCES `user_profile` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `orginization_ibfk_4` FOREIGN KEY (`orginization_id`) REFERENCES `orginization` (`orginization_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=712804665 DEFAULT CHARSET=latin1;

INSERT INTO `orginization` (`orginization_id`, `name`, `location`) VALUES (NULL, 'Sherwood Parkdale Minor Hockey Association', '11 Rogers Lane, Charlottetown PEI C1A 0A3'), (NULL, 'Charlottetown Minor Hockey association', 'PO Box 2343 Charlottetown PEI C1A 8C1'), (NULL, 'Charlottetown Ringette Association', '35 Prince Charles Dr.'), (NULL, 'Softball PE', 'PEI'), (NULL, 'Hillsborough Soccer Association', 'PEI'), (NULL, 'Basketball PEI', 'PEI'), (NULL, 'Squash PEI', 'PEI');

-- INSERT INTO `user_profile` (`user_id`, `username`, `password`, `first_name`, `last_name`, `address`, `phone`, `email`) VALUES ('712804665', 'test_user', '123', 'Test', 'User', 'Place st 123', '19021231234', 'testuser@email.com');

-- INSERT INTO `business_profile` (`business_id`, `username`, `password`, `name`, `address`, `phone`, `owner_first_name`, `owner_last_name`, `email`, `type`) VALUES ('712804665', 'test_business', '123', 'Test Store', 'Test st 123', '19021231234', 'business', 'owner', 'testbusiness@email.community_game_changer', 'S');

INSERT INTO `transaction` (`transaction_id`, `user_id`, `business_id`, `amount`, `liters`, `debit_or_credit`) VALUES (NULL, '712804665', '712804665', '200.00', '0.00', 'Debit');
INSERT INTO `transaction` (`transaction_id`, `user_id`, `business_id`, `amount`, `liters`, `debit_or_credit`) VALUES (NULL, '712804665', '712804665', '32.60', '0.00', 'Debit');
INSERT INTO `transaction` (`transaction_id`, `user_id`, `business_id`, `amount`, `liters`, `debit_or_credit`) VALUES (NULL, '712804665', '712804665', '89.20', '0.00', 'Credit');
INSERT INTO `transaction` (`transaction_id`, `user_id`, `business_id`, `amount`, `liters`, `debit_or_credit`) VALUES (NULL, '712804665', '712804665', '60.40', '0.00', 'Debit');
INSERT INTO `transaction` (`transaction_id`, `user_id`, `business_id`, `amount`, `liters`, `debit_or_credit`) VALUES (NULL, '712804665', '712804665', '8.32', '0.00', 'Debit');
INSERT INTO `transaction` (`transaction_id`, `user_id`, `business_id`, `amount`, `liters`, `debit_or_credit`) VALUES (NULL, '712804665', '712804665', '34.60', '0.00', 'Credit');
INSERT INTO `transaction` (`transaction_id`, `user_id`, `business_id`, `amount`, `liters`, `debit_or_credit`) VALUES (NULL, '712804665', '712804665', '10.80', '0.00', 'Debit');
INSERT INTO `transaction` (`transaction_id`, `user_id`, `business_id`, `amount`, `liters`, `debit_or_credit`) VALUES (NULL, '712804665', '712804665', '34.50', '0.00', 'Debit');
INSERT INTO `transaction` (`transaction_id`, `user_id`, `business_id`, `amount`, `liters`, `debit_or_credit`) VALUES (NULL, '712804665', '712804665', '23.65', '0.00', 'Credit');
INSERT INTO `transaction` (`transaction_id`, `user_id`, `business_id`, `amount`, `liters`, `debit_or_credit`) VALUES (NULL, '712804665', '712804665', '89.10', '0.00', 'Credit');
INSERT INTO `transaction` (`transaction_id`, `user_id`, `business_id`, `amount`, `liters`, `debit_or_credit`) VALUES (NULL, '712804665', '712804665', '12.89', '0.00', 'Debit');
INSERT INTO `transaction` (`transaction_id`, `user_id`, `business_id`, `amount`, `liters`, `debit_or_credit`) VALUES (NULL, '712804665', '712804665', '32.89', '0.00', 'Debit');

-- THIS IS A NEW DATABASE DESIGN
