			...
			<div class="carousel-item active"
				...
				<div class="bg-overlay">
					...
					<div class="carousel-caption d-none d-md-block">
						<h3 class="titel">Welcome</h3>
						<a class="btn btn-success btn-lg" href="./user/register">Join Now!</a>
						<p>To Community Game Changer</p>
					</div>
				</div>
			</div>
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#bc0722', endColorstr='#960518',GradientType=1 ); /* IE6-9 fallback on horizontal gradient */">
	...
	<div class="wrapper">
	<!-- <iframe id="top_ad_frame" src='' class="sidebar" frameborder='0' scrolling='no'></iframe> -->
		<div class="container">
