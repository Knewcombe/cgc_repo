	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-3 mt-5">
				<img src="https://media.istockphoto.com/photos/tell-me-more-about-this-picture-id541113838?k=6&m=541113838&s=612x612&w=0&h=i5zeSKbJjbX2GLDOVMuEljMujuXaoCDy4MBtT61XiK4=" class="w-100">
			</div>
			<div class="col-lg-6">
				<h1 class="mt-4 mb-3">What we were thinking...</h1>
